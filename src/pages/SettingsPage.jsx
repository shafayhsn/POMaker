...
export default function SettingsPage() {
  const { appSettings, actions } = useAppData()

  return (
    <div className="stack-lg">
      <PageHeader title="Settings" description="PO numbering, default terms, copy types, and company-level control rules." actions={<button className="secondary-button" onClick={actions.resetAllData}>Clear all app data</button>} />
